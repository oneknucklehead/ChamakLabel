  ...
  return (
    <div className="">
      <div className="grid grid-cols-12 gap-3">
        <div className="col-span-12 sm:col-span-4 aspect-[4/5] bg-primary/5">
          {image && (
        ...
        <div className="col-span-12 sm:col-span-8 text-[#6C4A6F] flex flex-col justify-center gap-3">
          <Link
            onClick={onClick}
            to={`/products/${product.handle}`}
            prefetch="intent"
          >
            <h3
              className="w-full text-xl  tracking-widest uppercase overflow-hidden whitespace-nowrap text-ellipsis "
              style={{
          ...
          <div className="flex gap-4">
            <h3
              className="flex gap-4 text-base text-black"
              style={{

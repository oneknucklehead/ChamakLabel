...
export { ProductCard2 } from './ProductCard2';
...
export { SliderHome } from './SliderHome.client';
export { FeaturedProductsSlider } from './FeaturedProductsSlider';
export { CustomModal } from './CustomModal';
export { ImageZoomInOut } from './ImageZoomInOut';
